      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-4">
            Latest <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-teal to-secondary-blue">Blog Posts</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Insights and thoughts on technology, development, and more. Join me on this journey of continuous learning and discovery.
          </p>
        </motion.div>

        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {(showMore ? blogPosts : blogPosts?.slice(0, 3))?.map((post, index) => (
            <motion.div
              key={post.id}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <Link 
            to="/archive" 
            className="group flex items-center gap-2 text-primary hover:text-primary-teal transition-colors"
          >
            View all blog posts
